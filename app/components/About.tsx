        ...
        <div className="max-w-7xl mx-auto w-full">
          ...
          >
            ...
            <div className="flex flex-col w-full">
              <motion.p variants={itemVariants} className="text-gray-300 text-3xl leading-relaxed max-w-md self-start text-left" style={{ fontFamily: 'var(--font-libertinus-math)' }}>
              ...
              <motion.p variants={itemVariants} className="text-gray-300 text-3xl leading-relaxed max-w-md self-end text-right mt-4" style={{ fontFamily: 'var(--font-libertinus-math)' }}>
